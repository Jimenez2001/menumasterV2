  ...
  return (
    ...
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
        <div className="md:w-1/6">
            <Image
                width={300}//Aqui mostraremos la imagen del producto en el resumen
                height={400}
        ...
        <div //Aqui mostraremos lo que es el nombre de los productos y la cantidad
        className="md:w-4/6">
            <p //El nombre del producto
            className="text-3xl font-bold">{producto.nombre}</p>
            <p //La cantidad que agregamos al pedido
            className="text-xl font-bold mt-2">Cantidad: {producto.cantidad}</p>
            <p //El precio Unitario 
            className="text-xl font-bold text-amber-500 mt-2">Precio: {formatearDinero(producto.precio)}</p>
            <p //El subtotal (Cantidad * precio)
            className="text-sm font-bold text-gray-700 mt-2">Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
        </div>
        ...
        <div>
            <button
                ...
                onClick={() => handleEditarCantidades(producto.id)}//Para que al darle click mande el id del producto
            >
